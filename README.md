...
因为在现阶段有部分的工具过于强大，比如说像 Webpack，导致了很多新手就误认为工程化就是 Webpack。这样的工具并不是工程化的核心，`工程化的核心应该是对项目整体的一种规划或者架构，而工具在这个过程当中，只是用来去落地去实现这种规划和架构的一种手段。`

可参考[这篇文章](https://juejin.cn/post/6884850799688548366)
